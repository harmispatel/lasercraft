...
use App\Models\{Category,CategoryProductTags,CategoryVisit,CheckIn,AdditionalLanguage, Building, Clicks, FoodJunction, ItemPrice, ItemReview, Items,ItemsVisit,Shop,UserShop,UserVisits,Option, OptionPrice, Order, OrderItems, Rooms, ShopTables, User};
use Carbon\Carbon;
...
class ShopController extends Controller
{
    ...
    public function getDetails(Request $request)
    {
        ...
        $store_schedule = checkStoreSchedule($request->shop_id);
            ...
            if(isset($item))
            {
                ...
                $html .='">';
                    ...
                    if(count($price_arr) > 0)
                    {
                        ...
                        if(isset($package_permissions['ordering']) && !empty($package_permissions['ordering']) && $package_permissions['ordering'] == 1 && $store_schedule == 1)
                        {
                            // Options
