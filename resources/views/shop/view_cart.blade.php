@php
    ...
    $is_checkout = ((isset($order_settings['delivery']) && $order_settings['delivery'] == 1) || (isset($order_settings['takeaway']) && $order_settings['takeaway'] == 1) || (isset($order_settings['room_delivery']) && $order_settings['room_delivery'] == 1) || (isset($order_settings['table_service']) && $order_settings['table_service'] == 1) || (isset($order_settings['office_service']) && $order_settings['office_service'] == 1)) ? 1 : 0;
                        ...
                        @if($is_checkout == 1)
                            <div class="col-md-4">
                                ...
                                <select name="checkout_type" id="checkout_type" class="form-control" {{ $disable_checkout_type }}>
                                    ...
                                    @endif
                                    @if(isset($order_settings['office_service']) && $order_settings['office_service'] == 1)
                                        <option value="office_service" {{ ($current_check_type == 'office_service') ? 'selected' : '' }}>{{ __('Office Service') }}</option>
                                    @endif
                                </select>
                            </div>
                        @endif
