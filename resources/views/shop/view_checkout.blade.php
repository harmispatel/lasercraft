                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @elseif($checkout_type == 'office_service')
                            <div class="row">
                                <div class="col-md-6 mb-2">
                                    <label for="office_no" class="form-label">{{ __('Office No.') }} <span class="text-danger">*</span></label>
                                    <input type="text" name="office_no" id="office_no" class="form-control {{ ($errors->has('office_no')) ? 'is-invalid' : '' }}" value="{{ old('office_no') }}">
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <select name="building" id="building" class="form-select {{ ($errors->has('building')) ? 'is-invalid' : '' }}">
