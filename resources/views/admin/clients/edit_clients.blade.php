                        ...
                        <div class="card-body">
                            ...
                            <div class="container">
                                ...
                                <div class="row">
                                    ...
                                    @if(isset($client->catalogue) && !empty($client->catalogue) && file_exists('public/client_uploads/shops/'.$client->hasOneShop->shop['shop_slug'].'/catalogue/'.$client->catalogue))
                                       <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                <label class="form-label">Shop Catalogue</label> <br>
                                                <a href="{{ asset('public/client_uploads/shops/'.$client->hasOneShop->shop['shop_slug'].'/catalogue/'.$client->catalogue) }}" download>{{ $client->catalogue }}</a>
                                            </div>
                                       </div>
                                    @endif
