                                ...
                                <tbody>
                                    @forelse ($clients as $client)
                                        <tr>
                                            ...
                                            <td>
                                                @php
                                                    $verified = $client->user_verify;
                                                    $verify_checked = ($verified == 1) ? 'checked' : '';
                                                    $verify_checkVal = ($verified == 1) ? 0 : 1;
                                                @endphp
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" role="switch" onchange="verifyUser({{ $verify_checkVal }},{{ $client->id }})" id="statusBtn" {{ $verify_checked }}>
                                                </div>
                                            </td>
                                            <td>
                                                @php
...
@section('page-js')
    <script type="text/javascript">
        ...
        // Function for Verify Client
        function verifyUser(verification, id)
        {
            $.ajax({
                type: "POST",
